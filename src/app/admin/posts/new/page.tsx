    ...
    <AdminLayout>
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="text-4xl font-bold text-white mb-2">פוסט חדש</h1>
            <p className="text-gray-400">Create New Post</p>
          </div>
          <button
            onClick={() => router.back()}
        ...
        {!showPreview ? (
          ...
          <div className="glass-card p-8 prose max-w-none">
            <h1 className="text-4xl font-bold text-cyan-400 mb-4">{title || "ללא כותרת"}</h1>
