...
export default function Footer() {
  ...
  return (
    <footer className="glass-card mt-20 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500">
              <span className="inline-block w-2 h-2 bg-cyan-400 rounded-full animate-pulse-slow"></span>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-semibold text-cyan-400 mb-4">קישורים מהירים</h3>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#books" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">
                  הספרים
                </Link>
              </li>
              <li>
          ...
          {/* Resources */}
          <div>
            <h3 className="text-lg font-semibold text-purple-400 mb-4">משאבים</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="/guides" className="text-gray-400 hover:text-purple-400 transition-colors text-sm">
                  מדריכים
                </Link>
              </li>
              <li>
          ...
          {/* Social Links */}
          <div>
            <h3 className="text-lg font-semibold text-orange-400 mb-4">עקבו אחרינו</h3>
            <div className="flex gap-4">
              <a
                href="https://github.com/openclaw"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-cyan-500 transition-all duration-200 group"
                aria-label="GitHub"
              >
                <svg
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-purple-500 transition-all duration-200 group"
                aria-label="Twitter"
              >
                <svg
                  className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-800 hover:bg-orange-500 transition-all duration-200 group"
                aria-label="LinkedIn"
              >
                <svg
                  className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors"
        ...
        <div className="pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm text-gray-400 text-center md:text-start">
              <p>
                Built by{" "}
                <a
                  href="https://pixmind.studio"
                  target="_blank"
                  rel="noopener noreferrer"
